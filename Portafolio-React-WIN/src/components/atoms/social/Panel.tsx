...
const links: SocialLinkType[] = [
  { text: "Github", icon: "SiGithub", href: "https://github.com/lic-miguelblanco/portfolio-fullstack-senior" },
  { text: "LinkedIn", icon: "FaLinkedinIn", href: "https://www.linkedin.com/in/lic-miguelblanco/" },
  { text: "Twitter", icon: "SiTwitter", href: "https://x.com/lic-miguelblanco" },
  { text: "Fandom", icon: "SiFandom", href: "https://dev.fandom.com/wiki/" },
];
